...
export const SUB_SERVICE_CONTENT: Record<string, SubServiceContent> = {
  "blocked-toilet": {
    ...
    relatedLinks: [
      ...
      { text: "Drain unblocking in Chelmsford", href: "/locations/chelmsford/drain-unblocking/" }
    ]
  },
  ...
  "blocked-bath": {
    ...
    pricingGuide:
      "Bath and shower drain unblocking in the Chelmsford area typically costs between £80 and £140. Shower trays with restricted access or blockages located further downstream may require additional work and cost slightly more. We always confirm the price before starting. No call-out fee applies.",
    faqs: [
  ...
  "pre-purchase-survey": {
    ...
    pricingGuide:
      "A pre-purchase CCTV drain survey in the Chelmsford area typically costs between £180 and £350 depending on the size of the property and the extent of the drainage network. Larger properties with multiple drainage runs or outbuildings sit towards the higher end. The price includes the survey, a full written report, and annotated footage.",
    faqs: [
  ...
  "drainage-investigation": {
    ...
    pricingGuide:
      "A targeted drainage investigation in the Chelmsford area typically costs between £150 and £300 depending on the complexity of the drainage system and the time required to identify the issue. Simple investigations where the cause is quickly located are at the lower end. We provide a fixed price before starting and there is no call-out fee.",
    faqs: [
  ...
  "commercial-jetting": {
    ...
    relatedLinks: [
      ...
      { text: "Blocked drains in Chelmsford", href: "/locations/chelmsford/blocked-drains/" }
    ]
  },
  ...
  "flooding-emergency": {
    ...
    pricingGuide:
      "Emergency flooding callouts in the Chelmsford area typically cost between £150 and £350 depending on the severity of the flooding and the work required to resolve the drainage failure. Pumping, jetting, and emergency repairs are included in the quoted price. We confirm costs before starting substantive work, and there is no call-out fee.",
    faqs: [
      { question: "How quickly can you respond to a flooding emergency?", answer: "We aim to arrive within 60 to 90 minutes for flooding emergencies across Chelmsford and surrounding areas. Flooding calls are given the highest priority in our dispatch system. Call us immediately — the sooner we arrive, the less damage your property sustains." },
  ...
  "sewage-emergency": {
    ...
    faqs: [
      ...
      { question: "Can you help if the problem is in the public sewer?", answer: "If the backup originates from the public sewer network rather than your private drainage, Essex & Suffolk Water is responsible for the repair. We can diagnose whether the issue is in your private drainage or the public network, and if it is a public sewer problem, we can provide emergency containment while you contact Essex & Suffolk Water." }
    ],
    relatedLinks: [
      { text: "Emergency drain services", href: "/services/emergency-drain-services/" },
